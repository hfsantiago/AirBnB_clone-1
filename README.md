...
<p align="center"><h2>An AirBnB_clone_v2.</h2></p>
...
| ----- | ----- | ------ |
| 0: Authors/README File | [AUTHORS](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/AUTHORS) | Project authors |
| 1: Pep8 | N/A | All code is pep8 compliant|
| 2: Unit Testing | [/tests](https://github.com/hfsantiago/AirBnB_clone_v2/tree/master/tests) | All class-defining modules are unittested |
| 3. Make BaseModel | [/models/base_model.py](https://github.com/hfsantiago/AirBnB_clone_v2/master/models/base_model.py) | Defines a parent class to be inherited by all model classes|
| 4. Update BaseModel w/ kwargs | [/models/base_model.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/base_model.py) | Add functionality to recreate an instance of a class from a dictionary representation|
| 5. Create FileStorage class | [/models/engine/file_storage.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/engine/file_storage.py) [/models/_ _init_ _.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/__init__.py) [/models/base_model.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/base_model.py) | Defines a class to manage persistent file storage system|
| 6. Console 0.0.1 | [console.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/console.py) | Add basic functionality to console program, allowing it to quit, handle empty lines and ^D |
| 7. Console 0.1 | [console.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/console.py) | Update the console with methods allowing the user to create, destroy, show, and update stored data |
| 8. Create User class | [console.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/console.py) [/models/engine/file_storage.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/engine/file_storage.py) [/models/user.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/user.py) | Dynamically implements a user class |
| 9. More Classes | [/models/user.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/user.py) [/models/place.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/place.py) [/models/city.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/city.py) [/models/amenity.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/amenity.py) [/models/state.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/state.py) [/models/review.py](https://github.com/hfsantiago/AirBnB_clone_v2/blob/master/models/review.py) | Dynamically implements more classes |
...
(viewable [here](https://github.com/Esteban1891/AirBnB_clone)), I, together
...
[version one](https://github.com/Esteban1891/AirBnB_clone) (the
